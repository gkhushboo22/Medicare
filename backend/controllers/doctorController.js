...
// Helper Functions
// Converts "hh:mm AM/PM" to total minutes since midnight
...
// this function will parse the schedule input which can be either a JSON string or an object, and return the deduped and sorted schedule
...
// this function will normalize the doctor object for client by converting the schedule from Mongoose Map to plain object, and also set default values for availability, patients, rating and fee
    ...
    try{
        ...
        if(existing.imagePublicId){
            try{
                ...
                console.warn("Deletefromcloudinary: ",err?.message || err);
